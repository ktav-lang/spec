...
> следуют Ktav 0.7.0 — текущей стабильной спецификации. Реализациям,
...
> описано в [Приложении D спецификации 0.7.0](versions/0.7/spec.ru.md).
...
- **Текущая стабильная:** [Ktav 0.7.0](versions/0.7/spec.ru.md) — выпущена 2026-09-10; обзор возможностей этого README следует ей.
...
[`versions/<v>/tests/`](versions/0.7/tests/). В корпусе 0.7.0
