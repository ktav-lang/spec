...
конфигурации, но MUST по умолчанию трактовать документ как 0.8.0,
...
Заявление на любом из уровней подтверждается только прогоном
корпуса, выполненным раннером конформанс-тестов, который
удовлетворяет § 8.5.
...
显式选择其他目标版本,MUST 默认将文档视为 0.8.0 —— 本规范不
定义任何文档内版本标记。
