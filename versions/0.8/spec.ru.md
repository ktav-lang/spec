...
#### 5.9.12 Защита первого байта вывода
...
Две пары в одном Object с одинаковым эффективным ключом — это ошибка
`DuplicateKey` (§ 5.5).
...
### 6.16 Незакрытый квотированный ключ
...
### 8.5 Контракт раннера конформанс-тестов
...
### 10.7 Зачем квотированные ключи и зачем три символа кавычек?
