export default {
  en: `As of 0.7.0, a body containing a segment that trims to exactly
...
`,
  ru: `Начиная с 0.7.0, тело, содержащее сегмент, обрезающийся в точности
...
`,
  zh: `与上面的尾部空白情形无关,若体被迫采用 stripped 形式(通过修剪后
