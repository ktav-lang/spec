...
- Inline-составные (кроме пустых `{}` / `[]`) НИКОГДА не выводятся
  в канонической форме. Inline-составные во входных данных —
  валидный синтаксический сахар; каноническая форма всегда
  многострочна.
...
- **空 Object 值:** `key: {}` 单行。
- **空 Array 值:** `key: []` 单行。
- 除空 `{}` / `[]` 外,inline 复合值**绝不**以规范形式输出。输入中的
  inline 复合值是有效的语法糖;规范形式始终是多行。
