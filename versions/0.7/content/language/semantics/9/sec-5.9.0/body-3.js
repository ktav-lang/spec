export default {
  en: `A writer-conforming implementation MUST reject a non-representable
...
`,
  ru: `Узловая представимость рекурсивно проходит через значение каждой
...
`,
  zh: `上述每种不可表示情形都有一个稳定的**原因代码**(reason code),
