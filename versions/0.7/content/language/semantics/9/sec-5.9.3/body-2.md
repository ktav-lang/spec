...
замкнутым inline или одиночным открывающим брейсом (у неё всегда
есть `:` разделитель); только Array-корни, чей первый элемент — составное
...
说明:Object 的 pair 行不会被误识为闭合 inline 或单独开启符的
根行(总有 `:` 分隔符);仅当首项本身是复合值(Object 或
Array,空或非空)时,Array 根才需要包裹。另一种风险 ——
