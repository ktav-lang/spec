export default {
  en: `A key segment is emitted in one of two forms — **bare** or
...
`,
  ru: `Сегмент ключа выводится в одной из двух форм — **голой** или
...
`,
  zh: `若选择裸形式,writer MUST 对 \`<key-char>\`(§ 4)从原始内容中排除
