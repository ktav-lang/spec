export default {
  en: `- **Root Object, first-serialized key.** If the root is a non-empty
...
`,
  ru: `- **Корневой Object, первый сериализуемый ключ.** Если корень —
...
`,
  zh: `这两种情形都是狭窄的、针对形式选择的例外:它们只改变 writer
