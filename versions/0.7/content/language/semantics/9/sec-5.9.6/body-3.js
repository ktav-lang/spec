export default {
  en: `- **Bare non-String scalar item:** emit the canonical scalar body on its own
...
`,
  ru: `- **Голый не-String скалярный элемент:** вывести каноническое тело
...
`,
  zh: `- **裸非 String 标量项:** 在当前缩进的自身行上输出规范标量体,不使用
