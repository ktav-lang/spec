export default {
  en: `   Detection is deliberately two-phase. Phase 1 (this rule) is a
...
`,
  ru: `   Детекция нарочно двухфазная. Фаза 1 (это правило) — чисто
...
`,
  zh: `根类型由首条内容行**固定**。随后的各行根据所选类型按 § 5.1 分发:
