export default {
  en: `For rules 6–9, a body beginning with \`{\` or \`[\` is scanned with the
...
`,
  ru: `Для правил 6–9 тело, начинающееся с \`{\` или \`[\`, сканируется с учётом
...
`,
  zh: `对于规则 6–9,以 \`{\` 或 \`[\` 开头的体按 § 5.8 的 quote-aware、escape-aware
