export default {
  en: `  Prior to 0.7, trailing whitespace on each line was preserved
...
`,
  ru: `  До 0.7 замыкающий пробел в каждой строке сохранялся verbatim, точно
...
`,
  zh: `  0.7 之前,每行的尾部空白会被逐字节保留,与下方的 verbatim 形式
