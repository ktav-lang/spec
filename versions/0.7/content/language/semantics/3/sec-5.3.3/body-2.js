export default {
  en: `A key segment MAY be written as a \`<quoted-segment>\` (§ 4) instead of
...
`,
  ru: `Сегмент ключа MAY быть записан как \`<quoted-segment>\` (§ 4) вместо
...
`,
  zh: `键段 MAY 写成 \`<quoted-segment>\`(§ 4)而非 \`<bare-segment>\`:由
