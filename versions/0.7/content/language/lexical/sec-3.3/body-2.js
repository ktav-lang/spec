export default {
  en: `Whitespace at the beginning of a line is **indentation** and is
...
`,
  ru: `Пробелы в начале строки — это **отступ** и значимы только для
...
`,
  zh: `行首空白是**缩进**,仅对人类可读性有意义;解析器忽略之(除非用作
