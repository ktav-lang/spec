export default {
  en: `This category does NOT cover an inline-pair position (§ 5.8.2): an
...
`,
  ru: `Эта категория НЕ покрывает позицию inline-пары (§ 5.8.2): незакрытый
...
`,
  zh: `此类别不覆盖 inline pair 位置(§ 5.8.2):那里未闭合的 quoted 键
