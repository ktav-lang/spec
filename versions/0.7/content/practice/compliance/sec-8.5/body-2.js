export default {
  en: `These checks bound the corpus itself — which fixtures exist, how
...
`,
  ru: `Эти проверки касаются самого корпуса — какие фикстуры существуют,
...
`,
  zh: `这些检查约束的是语料库本身——存在哪些 fixture、有多少个,以及
