export default {
  en: `- Satisfies every normative MUST / MUST NOT statement in this
...
`,
  ru: `- Удовлетворяет каждому нормативному MUST / MUST NOT в этом
...
`,
  zh: `- 满足本文档所有与解析相关的规范性 MUST / MUST NOT 声明。
