export default {
  en: `1. **A leading byte-order mark (U+FEFF) is now stripped from the document.**
...
`,
  ru: `1. **Ведущий маркер порядка байтов (U+FEFF) теперь удаляется из документа.**
...
`,
  zh: `1. **前导字节顺序标记(U+FEFF)现在会从文档中剥除。** 0.7.0
