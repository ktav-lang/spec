export default {
  en: `4. **A recognised escape in an inline scalar now forces String before
...
`,
  ru: `4. **Распознанный escape в inline-скаляре теперь фиксирует String до
...
меняется.
`,
  zh: `此外,\`\\uXXXX\` 是一个纯新增的 escape(§ 3.7.1)—— 不会因此改变任何
现有文档的含义。
`,
};
