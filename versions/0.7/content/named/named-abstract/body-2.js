export default {
  en: `0.7.0: § 3.3 whitespace changes from an implementation-defined \`MAY\` to
...
`,
  ru: `0.7.0: § 3.3 меняется с зависящего от реализации \`MAY\` на фиксированное,
...
`,
  zh: `0.7.0:§ 3.3 从依赖具体实现的 \`MAY\` 变为固定、穷举列出的 25 个码点的
