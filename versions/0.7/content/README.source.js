...
именованные секции стоят на своих реальных позициях в документе. При
добавлении юнита вставьте его имя в правильную позицию вручную.
...
2. Вставьте оба имени папок в \`manifest.js\` на правильные позиции
   документа (после юнита, предшествующего секции 9.9).
