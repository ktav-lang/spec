...
Требование к пишущему использовать каноническую raw-marker-форму
элемента для намеренного пустого String делает намерение явным и
ловит
...
使用规范的 raw-marker 项形式使意图显式,并在解析时捕获常见笔误。
