export default {
  en: `Tab (\`0x09\`) and other low-ASCII control bytes other than \`LF\` and
...
`,
  ru: `Табуляция (\`0x09\`) и другие управляющие байты нижней части ASCII,
...
`,
  zh: `多行标量值与多行字符串完全不做 escape 处理 —— 词法布局使 escape 在这些上下文中
