...
представимость. Если узловая представимость обнаруживает среди
потомков Value более одного нарушения (например, два элемента
Array, каждый непредставим по своей причине), реализация MAY
сообщить о любом одном из них: настоящая спецификация не
