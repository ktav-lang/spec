...
- **§ 5.9.0 (новый) — представимые Values теперь нормативно
  ...
  частичного вывода. Ранее § 5.9 не различал абстрактный программный
  Float-носитель и заявленный конечный парсируемый/канонический домен
  Float. Носитель MUST различать NaN, +Infinity и -Infinity, чтобы три
...
- **§ 5.9 / § 8.3** теперь определяют гарантию round-trip только для
  **представимых** (representable) Value. Строки с байтом `CR` или с
  ...
  исключены § 5.9.7 из множества представимых и являются
